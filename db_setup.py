...
def init_db():
    with app.app_context():
        ...
        #klett
        {"title": 'Teacher Tool for Classroom Management', "style": 'Klett', "thumbnail_url": 'img40.png', "course_url": 'https://demos.mitrmedia.com/demo-zip/demo/Klett_Classroom/index.html','description':'An application having various tools to assist teachers in effective handling of classroom'},
        {"title": 'Geometry Tool', "style": 'Klett', "thumbnail_url": 'img25.png', "course_url": 'https://demos.mitrmedia.com/demo-zip/demo/geometry_tool/index.html','description':'A Geometry Practice application designed for students to explore and solve geometric problems. '},
        {"title": 'Parallelogram Construction Application', "style": 'Klett', "thumbnail_url": 'img24.png', "course_url": 'build1/app.html','description':'An application which demonstrates as well as allows students to practise step by step construction of a parallelogram'},
        ...
        {"title": 'Counting numbers till 6 - Accessible', "style": 'Klett', "thumbnail_url": 'img55.png', "course_url": 'https://webhost.mitrmedia.com/ftp/mitr_sims/Accessibility/Klett/Primary_Practice/b1/practice_1_Enter_quantities_up_to_6_10/','description':'Students learn counting till 6 by counting different types of items displayed on the screen. '},
        {"title": 'Display quantities in pictures', "style": 'Klett', "thumbnail_url": 'img9.png', "course_url": 'https://demos.mitrmedia.com/demo-zip/demo/Klett_Primary_Math/demo_0_display_quantities/index.html','description':'This application is used by teachers to teach quantities by demonstrating pictures of different types of items. '},
        ...
        {"title": 'Projectile Motion  - Accessible', "style": 'Klett', "thumbnail_url": 'img16.png', "course_url": 'build2/app.html','description':'Explore projectile motion though firing a canon'},
